package com.neurotec.samples.multibiometric.preferences;
...
//	public static final String CAPTURE_DEVICE = "face_capture_device";
	...
	public static void updateClient(NBiometricClient client, Context context) {
		...
		client.setFacesTemplateSize(NTemplateSize.get(Integer.valueOf(preferences.getString(TEMPLATE_SIZE, String.valueOf(NTemplateSize.MEDIUM.getValue())))));
		...
		client.setFacesDetectBaseFeaturePoints(preferences.getBoolean(DETECT_BASE_FEATURE_POINTS, false));
